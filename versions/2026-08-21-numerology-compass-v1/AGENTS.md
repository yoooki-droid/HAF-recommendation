...
- The repeat loop is daily number → current compass → desired compass → course collection → inner trajectory; favorites and trajectory persist locally across plays.
